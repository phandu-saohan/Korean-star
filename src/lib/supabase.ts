...
const SUPABASE_URL = (import.meta as any).env?.VITE_SUPABASE_URL || "https://burmybxmzighthlusixg.supabase.co";

const DEFAULT_ANON_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImJ1cm15YnhtemlnaHRobHVzaXhnIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODU3OTkwNjYsImV4cCI6MjEwMTM3NTA2Nn0.AvQWhUbkJU9gePH_hq15qugc2VviI6HlzLPe85J1GQk";
